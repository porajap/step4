...
public class CssdLogin3 extends GenericForwardComposer{
	...
	public void onCreate() throws Exception {
		...
		Label_Caption.setValue( ( S_DB.equals("") || S_DB.equals("cssd_vcy_test")) ? "เข้าสู่ระบบ (สำหรับทดลอง)" : ("เข้าสู่ระบบ " + S_DB.replace("cssd_vcy_test", "") ) );
