...
public class CssdLogin2 extends GenericForwardComposer{
	...
	public void onCreate() throws Exception {
		...
		Label_Caption.setValue( ( S_DB.equals("") || S_DB.equals("cssd_web_4")) ? "เข้าสู่ระบบ (สำหรับทดลอง)" : ("เข้าสู่ระบบ " + S_DB.replace("cssd_web_4_", "") ) );
