...
public class DateTime {
	...
	public static String convertDateEN2(String StrDate) { // YYYY-MM-dd To dd-MM-YYYY 
		int IntYear = Integer.valueOf(StrDate.substring(0,4));
//		return ( IntYear +"-"+StrDate.substring(3,5)+"-"+StrDate.substring(0,2));
		return (StrDate.substring(9,10) +"-"+StrDate.substring(6,7)+"-"+IntYear );
	}
	...
	public static String getMonthTHSub(int IntMonth) {
		String MonthTH = "";
		switch(IntMonth){
			case 1: MonthTH = "à¸¡.à¸„.";break;
			case 2: MonthTH = "à¸�.à¸ž.";break;
			case 3: MonthTH = "à¸¡à¸µ.à¸„.";break;
			case 4: MonthTH = "à¹€à¸¡.à¸¢.";break;
			case 5: MonthTH = "à¸ž.à¸„.";break;
			case 6: MonthTH = "à¸¡à¸´.à¸¢.";break;
			case 7: MonthTH = "à¸�.à¸„.";break;
			case 8: MonthTH = "à¸ª.à¸„.";break;
			case 9: MonthTH = "à¸�.à¸¢.";break;
			case 10: MonthTH = "à¸•.à¸„.";break;
			case 11: MonthTH = "à¸ž.à¸¢.";break;
			case 12: MonthTH = "à¸˜.à¸„.";break;
		}
		return MonthTH;
	}
	...
	public static String getMonthTH(String StrDate) { //MM
		...
		String MonthTH = "";
		switch(IntMonth){
			case 1: MonthTH = "à¸¡à¸�à¸£à¸²à¸„à¸¡";break;
			case 2: MonthTH = "à¸�à¸¸à¸¡à¸ à¸²à¸žà¸±à¸™à¸˜à¹Œ";break;
			case 3: MonthTH = "à¸¡à¸µà¸™à¸²à¸„à¸¡";break;
			case 4: MonthTH = "à¹€à¸¡à¸©à¸²à¸¢à¸™";break;
			case 5: MonthTH = "à¸žà¸¤à¸©à¸ à¸²à¸„à¸¡";break;
			case 6: MonthTH = "à¸¡à¸´à¸–à¸¸à¸™à¸²à¸¢à¸™";break;
			case 7: MonthTH = "à¸�à¸£à¸�à¸Žà¸²à¸„à¸¡";break;
			case 8: MonthTH = "à¸ªà¸´à¸‡à¸«à¸²à¸„à¸¡";break;
			case 9: MonthTH = "à¸�à¸±à¸™à¸¢à¸²à¸¢à¸™";break;
			case 10: MonthTH = "à¸•à¸¸à¸¥à¸²à¸„à¸¡";break;
			case 11: MonthTH = "à¸žà¸¤à¸¨à¸ˆà¸´à¸�à¸²à¸¢à¸™";break;
			case 12: MonthTH = "à¸˜à¸±à¸™à¸§à¸²à¸„à¸¡";break;
		}
	...
	public static String FormatThai(String StrDate) { 
		...
		String sMonth = null;
		switch( Month ){
			case 1:sMonth = "à¸¡à¸�à¸£à¸²à¸„à¸¡";
				break;
			case 2:sMonth = "à¸�à¸¸à¸¡à¸ à¸²à¸žà¸±à¸™à¸˜à¹Œ";
				break;
			case 3:sMonth = "à¸¡à¸µà¸™à¸²à¸„à¸¡";
				break;
			case 4:sMonth = "à¹€à¸¡à¸©à¸²à¸¢à¸™";
			break;
			case 5:sMonth = "à¸žà¸¤à¸©à¸ à¸²à¸„à¸¡";
			break;
			case 6:sMonth = "à¸¡à¸´à¸–à¸¸à¸™à¸²à¸¢à¸™";
			break;
			case 7:sMonth = "à¸�à¸£à¸�à¸Žà¸²à¸„à¸¡";
			break;
			case 8:sMonth = "à¸ªà¸´à¸‡à¸«à¸²à¸„à¸¡";
			break;
			case 9:sMonth = "à¸�à¸±à¸™à¸¢à¸²à¸¢à¸™";
			break;
			case 10:sMonth = "à¸•à¸¸à¸¥à¸²à¸„à¸¡";
			break;
			case 11:sMonth = "à¸žà¸¤à¸¨à¸ˆà¸´à¸�à¸²à¸¢à¸™";
			break;
			case 12:sMonth = "à¸˜à¸±à¸™à¸§à¸²à¸„à¸¡";
			break;
		}
